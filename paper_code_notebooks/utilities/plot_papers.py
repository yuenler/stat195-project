...
class plot_papers:
    ...
    def line_plot_tournament_per_model(self, evaluation_results, title, metric, loc=0, ylimit=0.35):
        ...
        for i in range(len(evaluation_results)):
            ax.plot(models,evaluation_results[i],label=tournaments[i],color=colors[i],linewidth=4,linestyle= linestyles[i],
    ...
    def line_plot_difference_baseline_full_information_model(self, differences, title, loc=0, ylimit=0.35):
        ...
        for i in range(len(differences)):
            ax.plot(tournaments,differences[i],label=metrics[i],color=colors[i],linewidth=4,linestyle= linestyles[i],
                    marker=markers[i],markersize=12)
